                    ...
                    <div class="card-body">
                        ...
                        <form action="updateproduct.php" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="itemcat" class="form-control" >
                            </div>
                            <div class="form-group mb-3">
                                <label for="">Image</label>
                                <input type="text" name="itemimag" class="form-control" >
                            </div>
                            <div class="form-group mb-3">
                                <button type="submit" name="updateproduct" class="btn btn-primary">Update Data</button>
...
if(isset($_POST['updateproduct']))
{
    ...
    $query = "UPDATE product SET Title=?, Description=?, Category=? ,Price=? , Image=? WHERE ProductId=? ";
 
    if($statement = mysqli_prepare($con,$query)){

        mysqli_stmt_bind_param($statement, 'sssssi',$pname,$Descr,$category,$price,$imag,$idp);
